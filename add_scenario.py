...
# SQLite database setup with added business_role column
...
ai_input = st.text_area("Enter a brief description of the scenario you want to generate", "Provide your scenario description here...")

if st.button("Generate"):
    with st.spinner("Generating scenario..."):
        # Define a system prompt to instruct the AI to output a JSON object
        ai_system_prompt = (
        ...
        try:
            ...
            # Store generated data in session state so that form fields can be pre-filled
...
business_role = st.text_input("Business Role", "")  # New text box for business role
