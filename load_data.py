...
def run_upload_data():
    ...
    st.title("Welcome! Uploading training documents for your employees here")
    ...
    def generate_questions(doc_text: str) -> list:
        ...
        using OpenAI's GPT-4-turbo. Each question should have four options labeled A, B, C, D,
        ...
        try:
            ...
            st.error("Error parsing generated questions. Please check the format of the response.")
            questions = []
        return questions
